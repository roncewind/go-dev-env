...
go run . --inputURL "file:///go/src/roncewind.git/move/loadtest-dataset-100.jsonl" --outputURL "amqp://guest:guest@192.168.6.94:5672"
...
```console
go run . --inputURL "amqp://guest:guest@192.168.6.94:5672"
```
